    ...
    <view class="under_container">
      ...
      <view class="author_info">
        <view class="author_avatar">
          <image :src=" avatar?env.baseUrl+avatar:'/static/images/individual/defaultAvatar.jpg'"/>
        </view>
...
import {getsSpecifiedPicture} from "@/api/function";
  ...
  methods: {
    ...
    init: async function (id) {
      ...
      try {
        ...
        let res = await getsSpecifiedPicture({
          seaImageId: id
        });
        if (res) {
          ...
          if ('drawingImage' in res) {
            this.originalImage = baseUrl + res.drawingImage.originalImage
            this.generateImage = baseUrl + res.drawingImage.generateImage
            this.isShow = false
          } else {
            this.originalImage = baseUrl + res.drawingText.originalImage
            this.generateImage = baseUrl + res.drawingText.generateImage
            this.isShow = true
          }
        } else {
          uni.showToast({
