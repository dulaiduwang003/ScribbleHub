        ...
        <div :class="seeIndex !== -1 ? 'containerOpen' : ''" class="container">
            <el-scrollbar height="100%" class="leftContent">
                <div v-for="(item,index) in list" :key="index" class="item">
                    <div class="name">{{ item.userDialogue }}</div>
                    <div class="time">收藏于{{ item.createdTime }}</div>
                    <div v-if="!item.isError" class="operation">
                        ...
                        <div @click="cancelCollection(item.id,index)" class="operationItem"
            ...
            <el-scrollbar v-if="seeIndex !== -1" height="100%" class="rightContent">
                <div class="title">{{ list[seeIndex].userDialogue }}</div>
                <div class="desc">
                    <v-md-editor :model-value="list[seeIndex].aiDialogue" mode="preview"
