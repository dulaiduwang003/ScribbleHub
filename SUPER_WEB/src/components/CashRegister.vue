            ...
            <div class="cash-info">
                <div class="cash-code-container" v-show="!showSucceed">
                    ...
                    <div class="cash-order-data">
                        <div class="cash-o-data">商品名称 :&nbsp;&nbsp;{{ outcome.name }}</div>
                        <div class="cash-o-data">商户订单号 :&nbsp;&nbsp;{{ outcome.id }}</div>
                        <div class="cash-o-data">创建时间 :&nbsp;&nbsp;{{ outcome.createdTime }}</div>
                        <div class="cash-amount">
                            <div class="cash-o-prompt">需付款&nbsp;&nbsp;&nbsp;</div>
                            <div class="cash-o-amount">￥{{ outcome.price }} 元</div>
                        </div>
                    </div>
                </div>
                ...
                <div style="padding-bottom: 190px" v-show="showSucceed">
                    <div class="cash-o-data pay-succeed-no">商户订单号 :&nbsp;&nbsp;{{ outcome.id }}
                    </div>
                    <el-button size="large" round @click="router().push({ path: '/Orders' })">查看我的订单</el-button>
                </div>
                <div style="font-size: 12px;color: #b0b0b0">对订单疑问 可在微信小程序端中联系客服</div>
            </div>
