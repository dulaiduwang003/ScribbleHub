...
public class ChatFourStrategyImpl implements ChatStrategy {
    ...
    public Long frequency() {
        return ChatComment.operateStructure.getChatFourFrequency();
    }
    ...
    public Flux<String> execution(final StrategyStructure config, final ChatGPTDto dto) {
        ...
        return chatUtils.chatWebClient(config)
                ...
                .body(BodyInserters.fromValue(ChatGPTDto.convertToGptFourModel(dto)))
                .retrieve()
